    ...
    <div className="w-full bg-white py-16 px-4 " id="cli">
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
            ...
            <div className="flex flex-col justify-center">
                ...
                <a href="https://github.com/the-pinbo/mim#how-to-install" target='blank' ><button className='bg-black w-[200px] rounded-md font-medium my-6 mx-auto md:mx-0 py-4 text-center text-[#00df9a]'>Get Started</button></a>
                </div>
        </div>
