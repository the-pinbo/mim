        ...
        >
            <div className="text-black flex">
                ...
                <div className="basis-7/12">
                    ...
                    {subtopic == 1 && <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>{CN_text.tcp_5_layer_modal.application_layer}</motion.div>}
                    {subtopic == 2 && <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>{CN_text.tcp_5_layer_modal.transport_layer}</motion.div>}
                    {subtopic == 3 && <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>{CN_text.tcp_5_layer_modal.network_layer}</motion.div>}
                    {subtopic == 4 && <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>{CN_text.tcp_5_layer_modal.data_link_layer}</motion.div>}
                    {subtopic == 5 && <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>{CN_text.tcp_5_layer_modal.physical_layer}</motion.div>}
                </div>
            </div>
        </motion.div>
    )
